...
- 관찰: epoch 10→11에서 loss -31% 추가 감소. test 정확도도 98.41% → 98.59%로 +0.18%p 점프
- **결정적 증거**: v2 phase 1(lr=1e-3, 10 epoch) 종료 시점 정확도가 98.41%로 baseline 최종(98.41%)과 정확히 같음 → **v2의 +0.21%p 향상은 거의 전부 lr decay 단계에서 발생**
